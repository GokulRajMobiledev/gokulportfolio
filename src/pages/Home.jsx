...
const Home = () => {
  const { heroData, aboutData, serviceData, animated, skillData, portfolioData, blogData, resumeData, reviewData, contactData, socialData } = data;
  return (
    <>
      <Hero data={heroData} animated={animated} socialData={socialData} data-aos="fade-right" />
