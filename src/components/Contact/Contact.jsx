            ...
            <div className="st-contact-info-wrap">
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Email</h4>
                  <Link to="#">gokulraj.mobiledev@gamil.com</Link>
                  <Link to="#">gokulraj74627@gmail.com</Link>
                </div>
              </div>
              <div className="st-single-contact-info">
                <div className="st-icon-wrap">
              ...
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Address</h4>
                  <span>2/96E, savadi kadu masinayakenpatty, ayothiyapattinam, salem - 636103</span>
                </div>
              </div>
